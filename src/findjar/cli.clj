...
(defn examples [opts]
  (let [monochrome        (:monochrome opts)
        render-optionally (fn [line] (if monochrome line (ansi/render line)))]
    ...
    (as-> [""
           ...
           ""
           ;;@|green,bold Success!|@ (Code: 0)"
           "     @|bold ~> findjar clojure/1.9.0 -n \"clj\" -g \"author.*Rich Hickey\"|@"
           ""
           ...
           "     @|red <<<<<<<|@ clojure-1.9.0.jar@META-INF/MANIFEST.MF"
           "     1 Manifest-Version: 1.0"
           "     2 Archiver-Version: @|red Plexus|@ Archiver"
           "     3 Created-By: Apache Maven"
           "     4 Built-By: jenkins"
           "     5 Build-Jdk: 1.7.0"
           "     6 Main-Class: clojure.main"
